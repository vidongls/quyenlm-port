...
export default function ProjectCard() {
	return (
		...
		>
			<article className="home-project-card flex w-[421px] -rotate-[13.86deg] flex-col items-start gap-4 rounded-3xl border-[3px] border-ink bg-white p-5 shadow-[4px_4px_0_rgba(30,30,30,0.15)]">
